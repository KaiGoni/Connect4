...
Description: Prompted an input and checked if the input is a valid input.Prepared the playMove()
    function to change the array when someone plays a valid move for the next day.
'''
